---
layout: story
og_title: "【開源治理系列 08】從「和」到一套能直接使用的文件：日本如何以 OSPO Starter Kit 支持產業"
og_description: "從 OSPOlogy Asia 的日本觀察出發，看 IPA 如何與企業及 OpenChain 社群共同整理 OSPO Starter Kit，將開源治理做成產業能採用、也能持續改進的一套文件。"
og_image: images/ospology-japan-wa-model.jpg
...
![OSPO Starter Kit 的文件範圍畫面](images/starter-kit-scope.png)
...
![OSPO Starter Kit 給 OSPO 承辦人的使用指南畫面](images/starter-kit-for-ospo-leads.png)
...
![OSPOlogy Asia 現場的日本 Model 與和之道分享](images/ospology-japan-wa-model.jpg)
...
![OSPOlogy Asia 日本場次的跨領域分享陣容](images/ospology-japan-panel.jpg)
...
![日本場次總結每個國家都有自己的和之道](images/ospology-every-country-wa.jpg)
...
![OSPO Starter Kit 文件中的公司名稱預留欄位](images/starter-kit-placeholder.png)
...
![OSPO Starter Kit 文件客製化步驟畫面](images/starter-kit-customization-steps.png)
